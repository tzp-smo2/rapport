...
from generateur_v15_CPO2_ruptures_full import generer_rapport
...
if xlsx_file and txt_file:
    with st.spinner("Analyse en cours..."):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            # Copie du logo avec nom explicite
            logo_path = os.path.join(tmpdir, "logo_tzp.png")
            ...
            # === GRAPH CORRIGÉ : on ne prend que les fichiers contenant "graph"
            graph_file = sorted(
                [f for f in os.listdir(tmpdir) if f.endswith(".png") and "graph" in f.lower()],
                reverse=True
            )[0]
