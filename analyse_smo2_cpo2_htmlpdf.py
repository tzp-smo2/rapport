...
st.title("🧪 Analyse SmO₂ & Rapport PDF HTML – CPO2")
...
if txt_file and excel_file:
    ...
    <head>
    <meta charset="UTF-8">
    <title>Rapport CPO2</title>
    <style>
        body {{ font-family: Arial; margin: 40px; }}
        .header {{ display: flex; align-items: center; }}
        .header img {{ height: 60px; }}
        .header h1 {{ font-size: 24px; margin-left: 20px; color: #004080; }}
    ...
    <body>
    <div class="header">
        <img src="logo.jpg" alt="Logo CPO2">
    ...
    if st.button("📄 Générer le PDF HTML"):
        try:
            ...
            st.download_button("💾 Télécharger le PDF", data=pdf_bytes, file_name="rapport_CPO2.pdf", mime="application/pdf")
